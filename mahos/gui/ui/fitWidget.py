...
class Ui_FitWidget(object):
    def setupUi(self, FitWidget):
        ...
        self.labelBox = QtWidgets.QComboBox(parent=self.layoutWidget)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.MinimumExpanding, QtWidgets.QSizePolicy.Policy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.horizontalLayout_3.addWidget(self.labelBox)
        self.applyloadBox = QtWidgets.QCheckBox(parent=self.layoutWidget)
        self.applyloadBox.setChecked(False)
        ...
        self.applyresultBox.setChecked(False)
        ...
        FitWidget.setTabOrder(self.indexBox, self.loadButton)
        FitWidget.setTabOrder(self.loadButton, self.popbufButton)
        FitWidget.setTabOrder(self.popbufButton, self.clearbufButton)
        FitWidget.setTabOrder(self.clearbufButton, self.fitButton)
        FitWidget.setTabOrder(self.fitButton, self.clearfitButton)
        FitWidget.setTabOrder(self.clearfitButton, self.labelBox)
        FitWidget.setTabOrder(self.labelBox, self.applyloadBox)
        FitWidget.setTabOrder(self.applyloadBox, self.applyresultBox)
        FitWidget.setTabOrder(self.applyresultBox, self.bufferTable)
        FitWidget.setTabOrder(self.bufferTable, self.paramTable)
        FitWidget.setTabOrder(self.paramTable, self.resultEdit)
