...
class Ui_trackDialog(object):
    def setupUi(self, trackDialog):
        ...
        self.gridLayout.addWidget(self.xzxnumBox, 11, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.yzylenBox, 15, 1, 1, 1)
        ...
        self.xzmodeBox.addItem("")
        self.xzmodeBox.addItem("")
        self.gridLayout.addWidget(self.xzmodeBox, 10, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.xzxlenBox, 11, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.xzznumBox, 12, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.yzznumBox, 16, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.xyxlenBox, 7, 1, 1, 1)
        self.lenLabel_3 = QtWidgets.QLabel(parent=trackDialog)
        self.lenLabel_3.setObjectName("lenLabel_3")
        self.gridLayout.addWidget(self.lenLabel_3, 14, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.yzystepLabel, 15, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.yzyoffsetBox, 15, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.xyxstepLabel, 7, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.yzynumBox, 15, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.xyxnumBox, 7, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.yzzlenBox, 16, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.xzzlenBox, 12, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.xyxoffsetBox, 7, 4, 1, 1)
        self.xzzstepLabel = QtWidgets.QLabel(parent=trackDialog)
        self.xzzstepLabel.setObjectName("xzzstepLabel")
        self.gridLayout.addWidget(self.xzzstepLabel, 12, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.xzzoffsetBox, 12, 4, 1, 1)
        self.numLabel = QtWidgets.QLabel(parent=trackDialog)
        self.numLabel.setObjectName("numLabel")
        self.gridLayout.addWidget(self.numLabel, 6, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.lenLabel_2, 10, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.xzxoffsetBox, 11, 4, 1, 1)
        self.xyystepLabel = QtWidgets.QLabel(parent=trackDialog)
        self.xyystepLabel.setObjectName("xyystepLabel")
        self.gridLayout.addWidget(self.xyystepLabel, 8, 3, 1, 1)
        ...
        self.yzmodeBox.addItem("")
        self.yzmodeBox.addItem("")
        self.gridLayout.addWidget(self.yzmodeBox, 14, 0, 1, 1)
        ...
        self.xymodeBox.addItem("")
        self.xymodeBox.addItem("")
        self.gridLayout.addWidget(self.xymodeBox, 6, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.yzzstepLabel, 16, 3, 1, 1)
        self.lenLabel = QtWidgets.QLabel(parent=trackDialog)
        self.lenLabel.setObjectName("lenLabel")
        self.gridLayout.addWidget(self.lenLabel, 6, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.xyyoffsetBox, 8, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.xyynumBox, 8, 2, 1, 1)
        ...
        self.gridLayout.addWidget(self.stepLabel_2, 10, 3, 1, 1)
        ...
        self.gridLayout.addWidget(self.xyylenBox, 8, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.yzzoffsetBox, 16, 4, 1, 1)
        ...
        self.gridLayout.addWidget(self.pd_lbBox, 4, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.pd_ubBox, 4, 2, 1, 1)
