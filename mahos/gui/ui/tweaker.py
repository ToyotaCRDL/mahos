...
class Ui_TweakerWidget(object):
    def setupUi(self, TweakerWidget):
        ...
        self.resetButton = QtWidgets.QPushButton(parent=TweakerWidget)
        ...
        TweakerWidget.setTabOrder(self.stopButton, self.resetButton)
        TweakerWidget.setTabOrder(self.resetButton, self.saveButton)
    ...
    def retranslateUi(self, TweakerWidget):
        ...
        self.resetButton.setText(_translate("TweakerWidget", "Reset"))
