...
class Ui_ODMR(object):
    def setupUi(self, ODMR):
        ...
        self.gridLayout_2.addWidget(self.bnumBox, 7, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.delayBox, 4, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.laserdelayBox, 6, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.pdrateBox, 3, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.windowBox, 5, 1, 1, 1)
        ...
        self.pd_lbBox = QtWidgets.QDoubleSpinBox(parent=self.measTab)
        ...
        self.gridLayout_2.addWidget(self.pd_lbBox, 3, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.laserwidthBox, 6, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.mwdelayBox, 6, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.backgroundBox, 4, 1, 1, 1)
        self.pd_ubBox = QtWidgets.QDoubleSpinBox(parent=self.measTab)
        ...
        self.gridLayout_2.addWidget(self.pd_ubBox, 3, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.bgdelayBox, 4, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.triggerwidthBox, 7, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.pulseButton, 6, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.mwwidthBox, 6, 4, 1, 1)
        self.cwButton = QtWidgets.QRadioButton(parent=self.measTab)
        self.cwButton.setObjectName("cwButton")
        self.gridLayout_2.addWidget(self.cwButton, 5, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.gatedelayBox, 5, 2, 1, 1)
        ...
        ODMR.setTabOrder(self.amlogBox, self.pdrateBox)
        ODMR.setTabOrder(self.pdrateBox, self.pd_lbBox)
        ODMR.setTabOrder(self.pd_lbBox, self.pd_ubBox)
        ODMR.setTabOrder(self.pd_ubBox, self.backgroundBox)
    ...
    def retranslateUi(self, ODMR):
        ...
        self.pdrateBox.setPrefix(_translate("ODMR", "rate: "))
        ...
        self.label_2.setText(_translate("ODMR", "Analog PD"))
        self.stepLabel.setText(_translate("ODMR", "step: "))
        self.pd_lbBox.setPrefix(_translate("ODMR", "lower: "))
        self.pd_lbBox.setSuffix(_translate("ODMR", " V"))
        ...
        self.pd_ubBox.setPrefix(_translate("ODMR", "upper: "))
        self.pd_ubBox.setSuffix(_translate("ODMR", " V"))
