...
class Ui_ODMR(object):
    def setupUi(self, ODMR):
        ...
        self.gridLayout_2.addWidget(self.pd_lbBox, 2, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.pd_ubBox, 2, 3, 1, 1)
        ...
        self.sgmodBox = QtWidgets.QCheckBox(parent=self.measTab)
        self.sgmodBox.setObjectName("sgmodBox")
        self.gridLayout_2.addWidget(self.sgmodBox, 1, 3, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.pdrateBox, 2, 1, 1, 1)
        ...
        ODMR.setTabOrder(self.sweepsBox, self.sgmodBox)
        ODMR.setTabOrder(self.sgmodBox, self.mwcontBox)
        ODMR.setTabOrder(self.mwcontBox, self.pdrateBox)
    ...
    def retranslateUi(self, ODMR):
        ...
        self.sgmodBox.setText(_translate("ODMR", "IQ modulation"))
