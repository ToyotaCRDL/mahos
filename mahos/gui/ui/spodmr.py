...
class Ui_SPODMR(object):
    def setupUi(self, SPODMR):
        ...
        self.gridLayout_2.addWidget(self.sweepsBox, 0, 5, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.lockinrepBox, 0, 4, 1, 1)
        ...
        SPODMR.setTabOrder(self.accumrepBox, self.lockinrepBox)
