...
class Ui_SPODMR(object):
    def setupUi(self, SPODMR):
        ...
        SPODMR.setTabOrder(self.invertinitBox, self.flipheadBox)
        SPODMR.setTabOrder(self.flipheadBox, self.reduceBox)
        ...
        SPODMR.setTabOrder(self.taumodeBox, self.flipYBox)
        SPODMR.setTabOrder(self.flipYBox, self.normalizeBox)
        SPODMR.setTabOrder(self.normalizeBox, self.offsetBox)
        SPODMR.setTabOrder(self.offsetBox, self.logXBox)
        SPODMR.setTabOrder(self.logXBox, self.logYBox)
        SPODMR.setTabOrder(self.logYBox, self.fftBox)
        SPODMR.setTabOrder(self.fftBox, self.complexBox)
        SPODMR.setTabOrder(self.complexBox, self.fg_gateButton)
        ...
        SPODMR.setTabOrder(self.fg_freqBox, self.fg_cwButton)
        SPODMR.setTabOrder(self.fg_cwButton, self.fg_disableButton)
    ...
    def retranslateUi(self, SPODMR):
        ...
        self.methodBox.setItemText(1, _translate("SPODMR", "T1"))
        self.methodBox.setItemText(2, _translate("SPODMR", "FID"))
        self.methodBox.setItemText(3, _translate("SPODMR", "Spin Echo (envelope)"))
        self.methodBox.setItemText(4, _translate("SPODMR", "Spin Echo (different tau)"))
        self.methodBox.setItemText(5, _translate("SPODMR", "CP"))
        self.methodBox.setItemText(6, _translate("SPODMR", "CPMG"))
        self.methodBox.setItemText(7, _translate("SPODMR", "XY4"))
        self.methodBox.setItemText(8, _translate("SPODMR", "XY8"))
        self.methodBox.setItemText(9, _translate("SPODMR", "XY16"))
        self.methodBox.setItemText(10, _translate("SPODMR", "180 pulse train"))
        self.methodBox.setItemText(11, _translate("SPODMR", "Spin Echo (90 pulse sweep)"))
        self.methodBox.setItemText(12, _translate("SPODMR", "Spin Lock"))
        self.methodBox.setItemText(13, _translate("SPODMR", "XY8 correlation"))
        self.methodBox.setItemText(14, _translate("SPODMR", "XY8 correlation (1 flip)"))
        self.methodBox.setItemText(15, _translate("SPODMR", "XY8 correlation (N flip)"))
        self.methodBox.setItemText(16, _translate("SPODMR", "ddgate: XY8-CPMG-XY8"))
        ...
        self.flipheadBox.setText(_translate("SPODMR", "flip head"))
        ...
        self.plotmodeBox.setItemText(6, _translate("SPODMR", "normalize1"))
        self.plotmodeBox.setItemText(7, _translate("SPODMR", "concatenate"))
