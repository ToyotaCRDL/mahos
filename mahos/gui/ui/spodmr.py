...
class Ui_SPODMR(object):
    def setupUi(self, SPODMR):
        ...
        self.freq1Box.setMaximum(3000.0)
        self.freq1Box.setSingleStep(10.0)
        self.freq1Box.setProperty("value", 2740.0)
        self.freq1Box.setObjectName("freq1Box")
        self.gridLayout_2.addWidget(self.freq1Box, 3, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.nomw1Box, 3, 5, 1, 1)
        ...
        self.power1Box.setMinimum(-65.0)
        self.power1Box.setMaximum(0.0)
        self.power1Box.setObjectName("power1Box")
        self.gridLayout_2.addWidget(self.power1Box, 3, 3, 1, 1)
        ...
        SPODMR.setTabOrder(self.nomwBox, self.freq1Box)
        SPODMR.setTabOrder(self.freq1Box, self.power1Box)
        SPODMR.setTabOrder(self.power1Box, self.nomw1Box)
        SPODMR.setTabOrder(self.nomw1Box, self.reduceBox)
        ...
        SPODMR.setTabOrder(self.invertsweepBox, self.t90pulseBox)
        SPODMR.setTabOrder(self.t90pulseBox, self.t180pulseBox)
        SPODMR.setTabOrder(self.t180pulseBox, self.paramTable)
    ...
    def retranslateUi(self, SPODMR):
        ...
        self.freq1Box.setPrefix(_translate("SPODMR", "freq1: "))
        self.freq1Box.setSuffix(_translate("SPODMR", " MHz"))
        ...
        self.nomw1Box.setText(_translate("SPODMR", "Do not turn on MW1"))
        self.power1Box.setPrefix(_translate("SPODMR", "power1: "))
        self.power1Box.setSuffix(_translate("SPODMR", " dBm"))
        ...
        self.t90pulseBox.setPrefix(_translate("SPODMR", "90 pulse: "))
        self.t90pulseBox.setSuffix(_translate("SPODMR", " ns"))
        self.t180pulseBox.setPrefix(_translate("SPODMR", "180 pulse: "))
        self.t180pulseBox.setSuffix(_translate("SPODMR", " ns"))
        self.label_11.setText(_translate("SPODMR", "negative 180 pulse indicates 90 pulse x 2"))
