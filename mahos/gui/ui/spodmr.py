...
class Ui_SPODMR(object):
    def setupUi(self, SPODMR):
        ...
        self.gridLayout_2.addWidget(self.pd_ubBox, 1, 4, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.sweepsBox, 0, 4, 1, 1)
        ...
        SPODMR.setTabOrder(self.accumrepBox, self.sweepsBox)
        ...
        SPODMR.setTabOrder(self.reduceBox, self.divideblockBox)
        SPODMR.setTabOrder(self.divideblockBox, self.tau2constBox)
    ...
    def retranslateUi(self, SPODMR):
        ...
        self.divideblockBox.setText(_translate("SPODMR", "divide long blocks"))
